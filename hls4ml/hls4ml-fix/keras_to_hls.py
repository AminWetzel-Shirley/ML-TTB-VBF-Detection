'''This file has been edited from the original hls4ml 0.2.0 as there were errors in the original. hls4ml have been notified.'''
...
with open(here + "\..\dimension_config.txt") as f:
     content = f.readlines()
     xdim = int((content[1][19:]).strip())
     ydim = int((content[2][19:]).strip())
